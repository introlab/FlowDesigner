...
namespace FD {
   ...
   * 
   ...
   class CvPrevContour : public BufferedNode {
      ...
      public:
      CvPrevContour(string nodeName, ParameterSet params)
      ...
      {           
         ...
         contours->setContours(contours->getContours()->h_prev);
      ...
      NO_ORDER_NODE_SPEEDUP(CvPrevContour)
   };
}//namespace FD
