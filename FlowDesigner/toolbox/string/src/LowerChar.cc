 ...
 */
#ifndef _LOWER_CHAR_CC_
#define _LOWER_CHAR_CC_
 ...
 * @input_name INPUT
 * @input_type string
 * @input_description String to lower case
 *
 * @output_name OUTPUT
 * @output_type string
 * @output_description lower case
 *
 END*/
namespace FD {
	...
	class LowerChar;
	DECLARE_NODE(LowerChar);
	
	class LowerChar : public BufferedNode {
	...
	public:
		LowerChar(std::string nodeName, ParameterSet params)
		...
		void calculate(int output_id, int count, Buffer &out)
		{
			try
			{
				...
				QString str = QString(QByteArray(words.c_str(),words.size())).toLower();
