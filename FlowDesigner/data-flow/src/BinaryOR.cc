...
*/
#ifndef _BINARY_OR_CC_
#define _BINARY_OR_CC_
...
BinaryOR::BinaryOR(string nodeName, ParameterSet params)
...
void BinaryOR::calculate(int output_id, int count, Buffer &out)
{
