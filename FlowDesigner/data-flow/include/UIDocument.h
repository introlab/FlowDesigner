...
namespace FD {
	...
	/**
	 ...
	 @author: Jean-Marc Valin, Dominic Létourneau
	 */
	...
	private:
		...
		/**
			This class will receive all events from networks created in the document.
			According to the event, the UIDocument will take action.
		 */
		class networkEventReceiver : public UINetwork::UINetworkObserverIF
		{
		public:
			networkEventReceiver(UIDocument *doc)
			: m_doc(doc)
			{
