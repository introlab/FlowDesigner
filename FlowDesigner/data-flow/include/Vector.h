...
namespace FD {
	...
	public:
		 ...
		 */
		virtual ObjectRef getIndex(size_t pos) = 0;
		 ...
		 */
		virtual void setIndex(size_t pos, ObjectRef val) = 0;
	...
	public:
		 ...
		 */
		virtual ObjectRef getIndex(size_t pos);
		...
		/**
		 ...
		 \param val The value to put at the desired position
		 */
		virtual void setIndex(size_t pos, ObjectRef val);
	...
	struct VecMethod {
		...
		static inline ObjectRef getIndex(Vector<T> &v, size_t pos) 
		{
			throw new GeneralException("VecMethod getIndex should never be called", __FILE__, __LINE__);   				
		}   
		static inline void setIndex(Vector<T> &v, size_t pos, ObjectRef val) 
		{
	...
	template <class T>
	inline ObjectRef Vector<T>::getIndex(size_t pos)
	{
		return VecMethod<T, TypeTraits<T>::kind>::getIndex(*this,pos);
	}
	
	template <class T>
	inline void Vector<T>::setIndex(size_t pos, ObjectRef val)
	{
