...
")
	...
	ADD_CUSTOM_COMMAND(
	  OUTPUT    ${CMAKE_BINARY_DIR}/${DEBIAN_PACKAGE_NAME}_${DEBIAN_PACKAGE_VERSION}-1_${DEBIAN_ARCHITECTURE}.deb
	  COMMAND   ${CMAKE_AR}
	  ARGS      -r ${CMAKE_BINARY_DIR}/${DEBIAN_PACKAGE_NAME}_${DEBIAN_PACKAGE_VERSION}-1_${DEBIAN_ARCHITECTURE}.deb
	...
	ADD_CUSTOM_TARGET(${DEBNAME}_deb
	  DEPENDS ${CMAKE_BINARY_DIR}/${DEBIAN_PACKAGE_NAME}_${DEBIAN_PACKAGE_VERSION}-1_${DEBIAN_ARCHITECTURE}.deb
	  )
